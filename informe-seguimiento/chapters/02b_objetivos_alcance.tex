...
\begin{itemize}
  ...
  \item \textbf{líneas pospuestas o fuera de alcance}: Clasificación avanzada de correos, avisos de contraseñas
\end{itemize}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{lX}
    ...
    Disponibilidad & Detectar caídas de servicios, enviar avisos proactivos por Telegram y aplicar autoreparaciones conservadoras cuando procede. \\
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{lXX}
    ...
    Altavoz o satélite de voz & Interacción oral distribuida. & Opcional, desde el teléfono también puedes accionar cualquier mensaje. \\
